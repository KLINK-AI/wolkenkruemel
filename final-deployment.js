 ...
 * Umgeht alle ES Module Probleme durch .cjs Dateien
 */
...
console.log('📅 .cjs Dateien zur Umgehung von ES Module Issues');
...
// Create CommonJS server file (.cjs extension)
...
// Write as .cjs file to force CommonJS
writeFileSync('final-server.cjs', serverCode);
console.log('✅ Created final-server.cjs');

// Start the server
console.log('\n🚀 Starting final deployment server...');
const server = spawn('node', ['final-server.cjs'], {
    stdio: 'inherit',
    env: {
        ...process.env,
        NODE_ENV: 'production',
...
console.log('✅ Final deployment solution active');
console.log('🔧 Using .cjs extension to force CommonJS');
