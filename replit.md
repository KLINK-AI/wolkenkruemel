...
- July 13, 2025. IMPLEMENTED: Native HEIC support with automatic conversion - Added heic2any library for seamless HEIC-to-JPG conversion across all upload components (CreateActivity, EditActivity, ProfilePage). iPhone users can now upload HEIC files directly and they are automatically converted to JPG with quality optimization. Accept filters restored to "image/*" for maximum compatibility.
