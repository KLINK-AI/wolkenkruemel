...
- July 13, 2025. RESOLVED: HEIC file handling completely optimized - Accept filters now prevent HEIC files from appearing in file selection dialog (they appear grayed out), comprehensive HEIC detection with clear iPhone instructions, and improved error handling across all upload components. iPhone users get clear guidance to use "Kompatibler" camera format.
