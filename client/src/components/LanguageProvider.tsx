...
const translations = {
  de: {
    ...
    'createActivity.image': 'Aktivitätsbild (Optional)',
    'createActivity.imageLabel': 'Aktivitätsbild (Optional)',
    'createActivity.imageUpload': 'Bild hochladen, um deine Aktivität ansprechender zu gestalten',
    ...
    'createActivity.difficulty': 'Schwierigkeitsgrad',
    'createActivity.difficultySelect': 'Schwierigkeit auswählen',
